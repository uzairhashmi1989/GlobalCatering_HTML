...
<head>
    ...
    <title>Global Catering | Food Safety </title>
            ...
            <div class="stroke-figure">
                <div class="container">
                    <div class="twocol-row">
                        <div class="col-50">
                            <div class="home-left-panel">
                                <h3 class="h3 head-number animate" data-animation="animate__fadeInUp" data-duration="200">Preparation <span class="small-number">02</span></h3>
                                <div class="home-left-panel__para-btn  home-left-panel__para-btn--inner">
                    ...
                    <div class="twocol-row">
                        <div class="col-50">
                            <div class="home-left-panel">
                                <h3 class="h3 head-number animate" data-animation="animate__fadeInUp" data-duration="200">Storage <span class="small-number">04</span></h3>
                                <div class="home-left-panel__para-btn  home-left-panel__para-btn--inner">
                                    <p class="animate" data-animation="animate__fadeInUp" data-duration="300">Store raw or cooked foods at correct temperatures in correct containers. Chill and refrigerate all items promptly. Do not overfill your fridge as air needs to circulate to keep the correct internal temperature. Use an external thermometer...</p>
                                    <a href="javascript:;" class="thm-btn animate" data-animation="animate__fadeInUp" data-duration="400">
                                        <span class="thm-btn__text">Read more</span>
                                        <span class="thm-btn__icon">
                                            <img src="/assets/svg/long-right-arrow.svg" alt="icon" width="26" height="15" class="svg-convert">
            ...
            <div class="container">
                <ul>
                    <li class=" animate" data-animation="animate__fadeInUp" data-duration="200">
                        <div class="img-wrapper">
                            <a href="#" target="_blank">
                                <img src="assets/images/food-safety/retail1.jpg" alt="retail1">
                            </a>
                        </div>
                    </li>
                    </a>
                    <li class=" animate" data-animation="animate__fadeInUp" data-duration="300">
                        <div class="img-wrapper">
                            <a href="#" target="_blank">
                                <img src="assets/images/food-safety/retail2.jpg" alt="retail2">
                            </a>
                        </div>
                    </li>
                    <li class=" animate" data-animation="animate__fadeInUp" data-duration="400">
                        <div class="img-wrapper">
                            <a href="#" target="_blank">
                                <img src="assets/images/food-safety/retail3.jpg" alt="retail3">
                            </a>
                        </div>
                    </li>
                    <li class=" animate" data-animation="animate__fadeInUp" data-duration="500">
                        <div class="img-wrapper">
                            <a href="#" target="_blank">
                                <img src="assets/images/food-safety/retail4.jpg" alt="retail4">
                            </a>
                        </div>
                    </li>
                    <li class=" animate" data-animation="animate__fadeInUp" data-duration="600">
                        <div class="img-wrapper">
                            <a href="#" target="_blank">
                                <img src="assets/images/food-safety/retail5.jpg" alt="retail5">
                            </a>
                        </div>
                    </li>
                    <li class=" animate" data-animation="animate__fadeInUp" data-duration="700">
                        <div class="img-wrapper">
                            <a href="#" target="_blank">
                                <img src="assets/images/food-safety/retail6.jpg" alt="retail6">
                            </a>
                        </div>
                    </li>
                    <li class=" animate" data-animation="animate__fadeInUp" data-duration="700">
                        <div class="img-wrapper">
                            <a href="#" target="_blank">
                                <img src="assets/images/food-safety/retail7.jpg" alt="retail7">
                            </a>
                        </div>
                    </li>
                    <li class=" animate" data-animation="animate__fadeInUp" data-duration="700">
                        <div class="img-wrapper">
                            <a href="#" target="_blank">
                                <img src="assets/images/food-safety/retail8.jpg" alt="retail8">
                            </a>
                        </div>
                    </li>
                    <li class=" animate" data-animation="animate__fadeInUp" data-duration="700">
                        <div class="img-wrapper">
                            <a href="#" target="_blank">
                                <img src="assets/images/food-safety/retail9.jpg" alt="retail9">
                            </a>
                        </div>
                    </li>
                </ul>
