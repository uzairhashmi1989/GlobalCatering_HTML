...
<head>
    ...
    <title>Global Catering | Privacy Policy </title>
    ...
    <main>
        ...
        <section class="hero-home inner--hero">
            <div class="container hero-home__container">
                <div class="hero-home__text">
                    <h1 class="h1 animate" data-animation="animate__fadeInUp" data-duration="200">Privacy Policy</h1>
                </div>
            </div>
        ...
        <section class="terms-sec thm-py-100">
            <div class="container">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis itaque reprehenderit quod iure commodi repudiandae saepe. Beatae dicta cumque neque.</p>
                <h3 class="h3">sub heading</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis itaque reprehenderit quod iure commodi repudiandae saepe. Beatae dicta cumque neque.</p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis itaque reprehenderit quod iure commodi repudiandae saepe. Beatae dicta cumque neque.</p>
            </div>
