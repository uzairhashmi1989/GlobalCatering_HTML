...
<body class="no-home">
    ...
    <main>
        ...
        <!-- blue section -->
        <section class="red-section blue-bg red-section--with--blue-bg ">
            <div class="stroke-figure thm-py-85">
                <div class="container">
                    <div class="twocol-row">
                        <div class="col-50">
        ...
        <!-- blue section -->
        <section class="blue-section blue-section--with-left-figure  thm-py-100 ">
        ...
        <section class="simple-center simple-center--red thm-py-190 ">
            <div class="container">
                <div class="simple-center__wrapper">
                    <p> <strong>GCS provides an extraordinary experience to its customers, ensuring complete satisfaction.</strong> 
