                                ...
                                <ul class="home-left-panel__counter countAnimate" id="counter">
                                    <li>
                                        <div class="count-num-wrapper">
                                            <span class="home-left-panel__counter__value count-num" data-count="4000">0</span>
                                        </div>
                                        <h6 class="home-left-panel__counter__title">Employees</h6>
                                    </li>
                                    <li>
                                        <div class="count-num-wrapper">
                                            <span class="home-left-panel__counter__value count-num" data-count="16">0</span>
                                        </div>
                                        <h6 class="home-left-panel__counter__title">Countries</h6>
                                    </li>
                                    <li>
                                        <div class="count-num-wrapper">
                                            <span class="home-left-panel__counter__value count-num "  data-count="450000">0</span>
                                        </div>
                                        <h6 class="home-left-panel__counter__title">satisfied customers</h6>
                                    </li>
                                    <li>
                                        <div class="count-num-wrapper">
                                            <span class="home-left-panel__counter__value count-num "  data-count="55">0</span>
                                        </div>
