...
<head>
    ...
    <title>Global Catering | Contact Us </title>
    <?php include 'includes/meta.php'; ?>
</head>

<body class="no-home contact-us-body">
    ...
    <main>
        ...
        <section class="hero-home inner--hero">
            <div class="container hero-home__container">
                <div class="hero-home__text">
                    <h1 class="h1 animate" data-animation="animate__fadeInUp" data-duration="200">Contact</h1>
                </div>
            </div>
        ...
        <!-- lets connect -->
        <section class="lets-connect thm-pb-100">
            <div class="container">
